...
<button name="button" style="background:#FFA500;border-color: #FFA500;color:white;" onclick="window.location.href='https://www.eventbrite.com/e/crypto-economics-security-conference-cesc-tickets-374418404527';"> Registration is now open (together with CESC)</button>
